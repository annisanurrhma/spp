...
String id = UserSession.get_id();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 500, -1, -1));
        ...
        getContentPane().add(btnSimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 560, 90, 30));
        getContentPane().add(tJumlah_bayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 500, 140, 30));
        getContentPane().add(tTanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 400, 140, 30));
        ...
        getContentPane().add(cbBulan, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 450, 140, 30));

        tNo_Transaki.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        tNo_Transaki.setText("Trns000");
        getContentPane().add(tNo_Transaki, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 140, -1));

        tPetugas.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        tPetugas.setText("~");
        getContentPane().add(tPetugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, 110, -1));

        tAngkatan.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        tAngkatan.setText("~");
        getContentPane().add(tAngkatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 300, 100, -1));

        tKelas.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        tKelas.setText("~");
        getContentPane().add(tKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 140, -1));

        tNama_siswa.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        tNama_siswa.setText("~");
        getContentPane().add(tNama_siswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 140, -1));

        jLabel16.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel16.setText("Cari Siswa");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 170, -1, -1));
        ...
        getContentPane().add(cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 170, 420, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 210, 540, 150));

        jLabel17.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel17.setText("Status Bayar");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 380, -1, -1));

        tNama_siswa1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        tNama_siswa1.setText("~");
        getContentPane().add(tNama_siswa1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 380, 420, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 410, 540, 160));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 580, 120, 30));
        ...
        getContentPane().add(tNisn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 210, 140, -1));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        jLabel11.setText("~");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 300, 70, -1));

        tId_petugas.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        tId_petugas.setText("~");
        getContentPane().add(tId_petugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 330, 70, -1));

        jLabel12.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        jLabel12.setText("/");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 330, 20, -1));

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        jLabel13.setText("/");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 50, 10));

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/TMPILAN.jpg"))); // NOI18N
        getContentPane().add(bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 640));
